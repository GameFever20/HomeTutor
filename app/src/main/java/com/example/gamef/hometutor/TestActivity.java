...
public class TestActivity extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    // User is signed out
                    setStatus("Not signed inn", false);
    ...
    private void setStatus(String statusString, boolean append) {
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            Toast.makeText(this, "Signed inn", Toast.LENGTH_SHORT).show();
            firebaseAuthWithGoogle(account);


        } else {
            // Signed out, show unauthenticated UI.
            Toast.makeText(this, " failed to Signed inn", Toast.LENGTH_SHORT).show();
        }
    }
